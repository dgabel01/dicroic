        ...
        <footer className="bg-gray-900 text-gray-300 py-12 mt-24">
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-12">
                    ...
                    {/* LEFT: Logo + Brand – perfectly clear & beautiful */}
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div className="space-y-1">
                            <p className="text-md font-bold text-gray-200 uppercase tracking-widest mb-2">
                                Audio • Video • Multimedia
                            </p>
                            <div className="flex items-center justify-center md:justify-start gap-3 text-md text-primary font-semibold">
                                <span className=" text-gray-200 rounded-full text-lg">
                                    Integrator
                                </span>
                    ...
                    {/* CENTER: Navigacija — perfectly centered */}
                    <div className="flex flex-col items-center flex-1">
                        <h3 className="text-lg font-semibold text-white mb-5">Navigacija</h3>
                    ...
                    <div className="flex flex-col items-center md:items-end">
                        ...
                        >
                            <div className="p-4 bg-gray-800 rounded-full group-hover:bg-primary transition-colors duration-300">
                                <svg
